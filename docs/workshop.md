...
Please see the documentation section on the left for more information.
...
* *git clone https://github.com/janmandel/Intro_GPU_Acceleration* and run the examples here - insert them in *alderaan_single_gpu.sh*
