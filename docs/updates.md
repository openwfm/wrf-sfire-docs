...
* Nodes math-alderaan-c[29-32] are draining, because math-alderaan-c29 has a bad memory board and they all will need to be powered down to install the replacement memory board when it arrives.
